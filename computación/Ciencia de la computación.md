Cualquier pieza de información puede representarse como un set de [[números]]. Los sistemas que computan pueden hacer poderosos **mapeos** de un set de números en otros. También, **cualquier programa en cualquier computadora es equivalente a un mapeo de número**.

Por ello, se puede decir que hay un conexión cercana entre pruebas [[Matemática|matemáticas]] y los programas de computadora.
